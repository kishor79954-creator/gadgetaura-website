    ...
    const fetchData = async () => {
      ...
      if (product.variants && Array.isArray(product.variants) && product.variants.length > 0) {
        ...
        const loadedVariants = product.variants.map((v: any) => ({
          ...
          price: v.price?.toString() || "", // Parse variant override price
          imageFile: null
        }))
                  ...
                  {existingImages.map((img, idx) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 bg-destructive text-white rounded-full p-1.5 opacity-100 hover:bg-red-600 transition-opacity shadow-sm"
                        title="Delete Image"
                      >
